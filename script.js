...
pizzaJson.map((item, index) => {
    ...
    pizzaItem.querySelector('a').addEventListener('click', (e) => {
        ...
        DQS('.pizzaInfo--actualPrice').innerHTML = `R$ ${pizzaJson[key].price.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}`;
...
DQSA('.pizzaInfo--cancelButton, .pizzaInfo--cancelMobileButton').forEach(item => item.addEventListener('click', closeModal));